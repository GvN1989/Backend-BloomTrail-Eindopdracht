...
INSERT INTO steps (step_id, step_name, step_start_date, step_end_date, step_status, step_goal, sequence, coaching_program_id)
VALUES
    (1,'Discovering Your Strengths', '01-04-2024', '07-04-2024', false, 'Complete StrengthsFinder assessment to identify top strengths', 1, 1),
    (2,'Understanding Talent Themes', '08-04-2024', '14-04-2024', false, 'Deep dive into individual talent themes and their impact', 2, 1),
    (3,'Applying Strengths to Daily Life', '15-04-2024', '21-04-2024', false, 'Use strengths to solve problems and make decisions', 3, 1),
    (4,'Overcoming Weaknesses Through Strengths', '22-04-2024', '28-04-2024', false, 'Learn how to manage weaknesses by leaning into strengths', 4, 1),
    (5,'Creating a Strengths-Based Development Plan', '29-04-2024', '05-05-2024', false, 'Set up long-term goals and growth strategies', 5, 1);


INSERT INTO steps (step_id, step_name, step_start_date, step_end_date, step_status, step_goal, sequence, coaching_program_id)
VALUES
    (6,'Understanding Strengths-Based Leadership', '15-03-2024', '21-03-2024', false, 'Identify leadership style based on strengths', 1, 2),
    (7,'Building Effective Communication Skills', '22-03-2024', '28-03-2024', false, 'Develop influence through communication techniques', 2, 2),
    (8,'Leading with Emotional Intelligence', '01-04-2024', '07-04-2024', false, 'Apply emotional intelligence to lead teams effectively', 3, 2),
    (9,'Strengths-Based Decision Making', '08-04-2024', '14-04-2024', false, 'Use strengths to make confident and impactful decisions', 4, 2),
    (10,'Sustaining Leadership Growth', '15-04-2024', '21-04-2024', false, 'Create a plan for continuous leadership development', 5, 2);
